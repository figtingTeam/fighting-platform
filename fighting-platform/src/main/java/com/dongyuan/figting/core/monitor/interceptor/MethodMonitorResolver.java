package com.dongyuan.figting.core.monitor.interceptor;

import java.lang.reflect.Method;
import java.util.Arrays;

import com.dongyuan.figting.core.monitor.annotions.MethodMonitor;
...
public class MethodMonitorResolver {
	...
	@Pointcut("execution(@com.dongyuan.figting.core.monitor.annotions.MethodMonitor * *(..))")
