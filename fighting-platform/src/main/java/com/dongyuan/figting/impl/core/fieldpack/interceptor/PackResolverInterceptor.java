package com.dongyuan.figting.impl.core.fieldpack.interceptor;
...
import com.dongyuan.figting.impl.core.fieldpack.annotions.PackEntity;
...
public class PackResolverInterceptor {
	...
	@Pointcut("execution(@com.dongyuan.figting.impl.core.fieldpack.annotions.PackTarget * *(..))")
