package com.midea.cmo2o.wx.impl.utils.hessian;
 ...
 * @version 1.0 
 */
public class TCHessianClientInterceptor extends UrlBasedRemoteAccessor implements MethodInterceptor {
	private Logger log = LoggerFactory.getLogger(TCHessianClientInterceptor.class);
	...
	public Object invoke(MethodInvocation invocation) throws Throwable {
		...
		String methodFullName = invocation.getMethod().getDeclaringClass().getName()+"."+invocation.getMethod().getName();
		/*Stopwatch stopwatch = SimonManager.getStopwatch(methodFullName);
		...
		try {
            ...
            log.debug("调第三方接口:{} 耗时情况:{}",methodFullName,endTime-startTime);
