package com.midea.cmo2o.wx.impl.core.monitor.interceptor;
...
import com.midea.cmo2o.wx.impl.core.monitor.annotions.MethodMonitor;
...
public class MethodMonitorResolver {
	...
	@Pointcut("execution(@com.midea.cmo2o.wx.impl.core.monitor.annotions.MethodMonitor * *(..))")
